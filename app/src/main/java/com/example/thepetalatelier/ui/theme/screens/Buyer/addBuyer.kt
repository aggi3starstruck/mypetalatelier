...
@Composable
fun AddBuyerScreen(navController: NavController) {
    val imageUri = rememberSaveable() {
        mutableStateOf<Uri?> (null)
    }
    val painter = rememberImagePainter(data = imageUri.value?: R.drawable.lpeony,
    ...
    Scaffold (
        ...
        Column (modifier = Modifier.padding(innerPadding)){
            ...
            OutlinedTextField(value = venue,
                ...
                placeholder = { Text(text = "Enter the Venue") },
...
@Composable
fun AddBuyerPreview(){
    AddBuyerScreen(rememberNavController())
}